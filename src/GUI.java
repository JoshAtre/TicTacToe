// ============================================================================
//     Tic Tac Toe game written by Josh Atre
...
public class GUI extends JFrame implements ActionListener {
    ...
    private JRadioButton selectComputer = new JRadioButton("User vs Computer", false);
    private JRadioButton selectUser = new JRadioButton("User vs User", false);
    ...
    public GUI() {
        ...
        JFrame window = new JFrame("Josh's Tic Tac Toe Game");
        window.setSize(X, Y);
            ...
            for (int i = 0; i < cells.length; ++i) {
                for (int j = 0; j < cells.length; j++) {
                    if (source == cells[i][j]) {
                        ...
                        if (gameMode == GameMode.SINGLE_PLAYER && getEmptyCellCount() > 0) {
                            cpuMakeMoveMiniMax();
                        }
